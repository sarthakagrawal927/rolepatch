  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-12">
      ...
      <p className="mt-3 text-sm text-stone-600">
        Paste your resume as markdown or plain text. Local heuristics
        flag the things ATS parsers and recruiter skim-readers actually
        care about. No network call — your text never leaves the page.
      </p>
