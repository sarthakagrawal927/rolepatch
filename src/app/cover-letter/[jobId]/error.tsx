  ...
  return (
    <div className="flex min-h-[60vh] items-center justify-center p-8">
      <div className="text-center max-w-md">
        <h2 className="text-xl font-bold mb-3">Couldn&apos;t load the cover letter</h2>
        <p className="text-sm opacity-70 mb-6">
          Something went wrong while preparing this page. Any saved drafts are safe — try again.
        </p>
