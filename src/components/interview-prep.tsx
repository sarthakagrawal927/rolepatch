    ...
    <div className="bg-[var(--card)] border border-[var(--border)]/60 rounded-xl overflow-hidden">
      ...
      {open && (
        <div className="px-5 pb-5 space-y-3 border-t border-[var(--border)]/30">
          {/* JD Requirement */}
          <div className="pt-3">
            <p className="text-[10px] font-black text-[var(--muted-foreground)] uppercase tracking-widest mb-1">
              Addresses
            </p>
            <p className="text-xs text-[var(--muted-foreground)] italic leading-relaxed">
              &ldquo;{story.jd_requirement}&rdquo;
            </p>
          </div>
          ...
          {[
            ...
            <div key={label}>
              <p className={`text-[10px] font-black uppercase tracking-widest mb-0.5 ${color}`}>
                {label}
              </p>
          ...
          {story.best_for.length > 0 && (
            <div className="pt-1">
              <p className="text-[10px] font-black text-[var(--muted-foreground)] uppercase tracking-widest mb-1.5">
      ...
      {stories.length > 0 ? (
        <div className="space-y-3">
          ...
          <div className="bg-[var(--card)] border border-[var(--border)]/60 rounded-xl p-5">
            <p className="text-[10px] font-black text-[var(--muted-foreground)] uppercase tracking-widest mb-3">
              Quick Reference — Question Coverage
            </p>
            <div className="flex flex-wrap gap-1.5">
        ...
        <div className="border border-dashed border-[var(--border)] rounded-2xl py-16 flex flex-col items-center justify-center bg-muted/20">
          <div className="w-14 h-14 rounded-full bg-background border border-[var(--border)] flex items-center justify-center mb-4">
            <svg
              className="w-7 h-7 text-[var(--muted-foreground)]/30"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
              strokeWidth={1.5}
